...
import IMG from "./assets/image/amir.png";
...
function App() {
  ...
  const seoContent: {
    ...
    en: {
      ...
      description:
        "Amir Rahemi is a passionate full-stack developer specializing in modern JavaScript, React, Next.js, Node.js, and TypeScript. Browse my portfolio projects and get in touch.",
      keywords:
        "Amir Rahemi, full-stack developer, web developer, React developer, Next.js, JavaScript, Node.js, portfolio, frontend developer, backend developer",
      ogTitle: "Amir Rahemi - Full-Stack Developer | React & Next.js",
      ogDescription:
        "Portfolio of Amir Rahemi - Skilled full-stack developer specializing in React, Next.js, and modern web technologies. View my projects and experience.",
      twitterTitle: "Amir Rahemi - Full-Stack Developer",
      twitterDescription:
        "Portfolio of Amir Rahemi - Skilled full-stack developer specializing in React, Next.js, and modern web technologies.",
    ...
    fa: {
      ...
      description:
        "امیر راحمی یک توسعه‌دهنده فول‌استک با تخصص در JavaScript مدرن، React، Next.js، Node.js و TypeScript است. پروژه‌های نمونه کار من را مشاهده کنید و با من در ارتباط باشید.",
      keywords:
        "امیر راحمی, توسعه دهنده فول استک, برنامه نویس وب, React, Next.js, JavaScript, Node.js, نمونه کار, فرانت اند, بک اند",
      ogTitle: "امیر راحمی - توسعه‌دهنده فول‌استک | React و Next.js",
      ogDescription:
        "نمونه کار امیر راحمی - توسعه‌دهنده فول‌استک با تخصص در React، Next.js و تکنولوژی‌های مدرن وب. پروژه‌ها و تجربیات من را ببینید.",
      twitterTitle: "امیر راحمی - توسعه‌دهنده فول‌استک",
      twitterDescription:
        "نمونه کار امیر راحمی - توسعه‌دهنده فول‌استک با تخصص در React، Next.js و تکنولوژی‌های مدرن وب.",
      siteName: "نمونه کار امیر راحمی",
      jobTitle: "توسعه‌دهنده فول‌استک",
      descriptionSchema:
        "توسعه‌دهنده فول‌استک متخصص در React، Next.js و تکنولوژی‌های مدرن وب",
    },
  };
    ...
    <div className="bg-[white] dark:bg-black h-screen text-white font-paytone rtl:font-lalezar font-medium transition-all capitalize">
      <Helmet>
        ...
        <meta
          ...
          content="g_1thjCsV9Zsk6mFnfvHTwtioi2tn7J4Zz_4ufHwNrg"
        />
        ...
        <link
          rel="alternate"
          hrefLang="en"
          href="https://amirrahemi.com?lang=en"
        />
        <link
          rel="alternate"
          hrefLang="fa"
          href="https://amirrahemi.com?lang=fa"
        />
        <link
          rel="alternate"
          hrefLang="x-default"
          href="https://amirrahemi.com"
        />
        ...
        <meta
          property="og:url"
          content={`https://amirrahemi.com?lang=${currentLang}`}
        />
        <meta property="og:site_name" content={content.siteName} />
        <meta
          property="og:locale"
          content={currentLang === "fa" ? "fa_IR" : "en_US"}
        />
        <meta
          property="og:locale:alternate"
          content={currentLang === "fa" ? "en_US" : "fa_IR"}
        />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href={`https://amirrahemi.com?lang=${currentLang}`}
        />
      ...
      <div className="flex flex-col justify-center w-full lg:w-3/4 my-0 mx-auto">
        <section className="[height:96vh] flex items-center justify-center flex-col [width: 90%] lg:w-full bg-black rounded-2xl m-4 dark:bg-black dark:m-0 dark:h-screen dark:rounded-none;">
          <div className="absolute bottom-20 z-40 p-3">
            <h2 className="text-2xl md:text-5xl lg:text-8xl">
              {t("header.hello")}
            </h2>
            <p className="text-sm md:text-3xl lg:text-5xl">
          ...
          <img
            className="absolute bottom-auto w-64 md:w-72 lg:w-80 lg:[bottom: 4vh]"
            src={IMG}
            alt=""
          />
        </section>
