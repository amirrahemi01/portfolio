  ...
  const socialLinks = [
    {
      ...
      href: "mailto:amirrahemi01@gmail.com",
    ...
    {
      icon: <FaGithub />,
      href: "https://github.com/amirrahemi",
      color: "hover:text-purple-400",
      label: "GitHub",
    },
    {
      icon: <FaFacebookF />,
      href: "https://facebook.com/madeby_amir",
      color: "hover:text-blue-500",
      label: "Facebook",
    },
    {
      icon: <FaInstagram />,
      href: "https://instagram.com/amirrahemiii",
    ...
    <div className="w-full py-20 px-4 relative" id="contact">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 text-center pb-4 md:pb-8 px-4 bg-gradient-to-r from-black to-gray-500 bg-clip-text text-transparent dark:from-white dark:to-gray-400">
            {t("content.contact")}
          </h2>
          <div className="h-1.5 w-24 md:w-32 mx-auto bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full"></div>
          <p className="text-slate-600 dark:text-slate-400 mt-4 text-base md:text-lg px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <form ref={form} onSubmit={sendEmail} className="space-y-6">
              ...
              <button
                type="submit"
                className="group relative w-full md:w-auto px-8 py-4 bg-gradient-to-r from-slate-800 to-slate-300 rounded-full text-white font-semibold text-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/50 hover:scale-105"
              >
                <span className="relative z-10">
                  {t("content.contactSendMessage")}
                </span>
