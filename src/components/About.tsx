...
import IMG1 from "../assets/image/amir2.png";
    ...
    <div className="w-full bg-white dark:bg-black" id="about">
      <div className="flex flex-col md:flex-row px-4">
        <div className="w-full ml-auto p-5">
          <img src={IMG1} alt="" className="a w-full filter grayscale" />
        </div>
        <br />
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-slate-800 dark:text-slate-300 text-sm lg:text-base text-justify">
            {t("content.reactjs")}
          </p>
      ...
      <div className="flex flex-col mt-4">
        <h1 className="px-4 text-2xl text-black dark:text-white">
          {t("content.my interests")}
        </h1>
