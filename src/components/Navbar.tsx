    ...
    <header className="flex flex-col items-center justify-start float-left fixed top-12 left-12 bottom-12 z-10 isolate">
      <nav className="flex flex-col justify-between items-center flex-auto max-w-12">
        ...
        <div className="flex flex-col items-center justify-center">
          <a href="https://twitter.com/madeby_amir" target="_blank" className="flex items-center justify-center p-0 w-12 h-12 text-white text-3xl"><FaXTwitter /></a>
          <a href="https://github.com/amirrahemi01" target="_blank" className="flex items-center justify-center p-0 w-12 h-12 text-white text-3xl"><FaGithub /></a>
